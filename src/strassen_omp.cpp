...
vec strassen_omp(vec a,vec b, int n)
{
	...
	t=clock();
	noalias(m1)= (simfor::classic_omp(a11+a22,b11+b22,n));
	noalias(m2)= (simfor::classic_omp(a21+a22,b11,n));
	noalias(m3)= (simfor::classic_omp(a11,b12-b22,n));
	noalias(m4)= (simfor::classic_omp(a22,b21-b11,n));
	noalias(m5)= (simfor::classic_omp(a11+a12,b22,n));
	noalias(m6)= (simfor::classic_omp(a21-a11,b11+b12,n));
	noalias(m7)= (simfor::classic_omp(a12-a22,b21+b22,n));
	c11=m1+m4-m5+m7;
	c12=m3+m5;
	c21=m2+m4;
	c22=m1+m3-m2+m6;
